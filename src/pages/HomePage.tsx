  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-120px)] p-8 rounded-lg text-center">
      ...
      <p className="text-xl text-gray-700 mb-8 max-w-2xl">
        Your ultimate solution for managing books and tracking borrowing activities efficiently.
        Explore our collection, add new books, update existing ones, and keep a track of borrowed items—all in one place.
      </p>
